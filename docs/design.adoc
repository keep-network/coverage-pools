...
part of the asset pool ownership. Initially, the amount of token reward is zero,
but the value can be updated by the governance (possibly multiple times).  The
current amounts of rewards can be viewed using the following methods of the risk
manager:
